...
type Config struct {
	...
	// EnableRecordSQL indicates that the TiDB is replaying the sql
	EnableRecordSQL AtomicBool `toml:"enable-record-sql" json:"enable_record_sql"`
	// True is millionsecond, false is second
	RecordSQLUnit AtomicBool `toml:"record-sql-unit" json:"record-sql-unit"`
...
var defaultConf = Config{
	...
	EnableRecordSQL:              *NewAtomicBool(false),
	ReplayMetaTS:                 0,
	RepairMode:                   false,
